Feature: site-intel skill — route questions about a known site to pre-built research docs
  ...
  Background:
    ...
    And docs/sites/example-com/research/ exists from a prior site-recon run

  Scenario: Question about endpoints routes to api-surfaces file
    When I ask "how do I fetch all products from example.com?"
    Then site-intel opens docs/sites/example-com/research/INDEX.md first
    And routes to docs/sites/example-com/research/api-surfaces/products.md
  ...
  Scenario: Question about tech stack routes to tech-stack file
    ...
    Then site-intel opens docs/sites/example-com/research/tech-stack.md
  ...
  Scenario: Question about available pages routes to site-map file
    ...
    Then site-intel opens docs/sites/example-com/research/site-map.md
  ...
  Scenario: Question about category IDs routes to constants file
    ...
    Then site-intel opens docs/sites/example-com/research/constants.md
  ...
  Scenario: OpenAPI spec request routes to specs file
    ...
    Then site-intel opens docs/sites/example-com/research/specs/example-com.openapi.yaml
  ...
  Scenario: No research docs found — user directed to run site-recon
    Given docs/sites/unknown-site/research/ does not exist
