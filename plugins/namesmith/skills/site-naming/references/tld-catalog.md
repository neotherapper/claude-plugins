...
| `.io` | check.io, build.io, data.io | Porkbun | Also used as standard TLD |
| `.me` | mak.me, track.me, host.me | Namecheap | |
| `.in` | bra.in, cha.in, tra.in, ma.in, conta.in | Namecheap | India ccTLD, widely registrable |
| `.at` | bl.at, fl.at, form.at, cre.at | Namecheap | Austria ccTLD |
| `.al` | sign.al, loc.al, critic.al, music.al | — | ⚠️ restricted to Albanian entities |
| `.am` | progr.am, stre.am, te.am | Namecheap | Armenia ccTLD |
| `.as` | canv.as, contr.as | Namecheap | American Samoa |
| `.be` | would.be, could.be, want.be | Namecheap | Belgium ccTLD |
| `.by` | stand.by, drop.by | Namecheap | Belarus ccTLD — check policy |
| `.co` | dis.co, roc.co | Porkbun | Colombia ccTLD, popular |
| `.do` | can.do, to.do, win.do | — | ⚠️ restricted to Dominican entities |
| `.es` | expr.es | Namecheap | Spain ccTLD — check policy |
| `.gy` | ener.gy | Porkbun | Guyana ccTLD |
