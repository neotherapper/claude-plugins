...
### Wave 1 (default)
Generate 25–35 candidates across all 7 archetypes. Apply weighting from brand-interview.md. Use the per-archetype base distribution targets from SKILL.md Step 4. Do not check availability during generation — generate the full list first, then batch-check.
